...
public class EnterValidEmailAndInvalidPassword {
...
@Test
	public void enterValidEmailAndInvalidPassword() {
		...
		WebElement invalidPassword = driver.findElement(By.xpath("//input[@id='user_password']"));

		invalidPassword.sendKeys("Test@1235");
